...
This repository contains the third stage of a student project to build a clone of the AirBnB website. This project aims to create a REST API for our site using flask web framework.

## Environment
This project is interpreted/tested on Ubuntu 20.04 LTS using python3 (version 3.4.3)

## Installation
* Clone this repository: `git clone "https://github.com/hillary-254/AirBnB_clone_v3.git"`
